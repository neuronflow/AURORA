...
single_inference(
    ...
    whole_network_outputs_file="your_whole_metastasis_file.nii.gz", # optional: whether to save network outputs for the whole metastasis
    enhancing_network_outputs_file="your_enhancing_metastasis_file.nii.gz", # optional: whether to save network outputs for the enhancing metastasis
